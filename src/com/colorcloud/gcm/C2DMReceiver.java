...
/**
 * deprecated. This is the old way of handling GCM. 
 * Google gcm.jar has hides the details of retry handling and expose easy callback for GCM intent handling.
 */
	...
	public void onReceive(Context context, Intent intent) {
		...
		if ("com.google.android.c2dm.intent.REGISTRATION".equals(action)) {
			...
			if ("SERVICE_NOT_AVAILABLE".equals(error)) {
				// schedule a retry
		        Log.d("com.colorcloud.gcm", "Scheduling registration retry, backoff = " + backoffTimeMs);
			...
			// get the phone name
			SharedPreferences prefs = context.getSharedPreferences("com.colorcloud.gcm",
		...
		/*
		} else if ("com.colorcloud.gcm.RETRY".equals(action)) {
...
//		Editor edit = prefs.edit();
		...
		boolean regOk = prefs.getBoolean(MainActivity.REGISTERED, false);
		...
		if (regOk != true)
		{
			...
			serviceIntent.setAction("com.colorcloud.gcm.GcmService");
